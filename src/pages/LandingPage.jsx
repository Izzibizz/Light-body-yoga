...
export const LandingPage = () => {
  ...
  return (
    <section className="animate-fadeIn ">
      ...
      <div className="relative top-5 w-full flex z-40 flex flex-col gap-20">
        
      <div className="flex flex-col laptop:flex-row w-10/12 mx-auto mt-32 laptop:justify-end items-center gap-10">
        ...
        <img src="https://res.cloudinary.com/dbf8xygxz/image/upload/v1739100255/svg_test-text_nmxvhb.svg" alt="text" className="tablet:absolute w-full tablet:w-1/2 laptop:w-[40%] [750px] tablet:left-10 tablet:top-2/3 laptop:left-[8%] laptop:top-[28%]"/>
