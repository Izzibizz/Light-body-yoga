        ...
        <div className="flex flex-col laptop:flex-row gap-10 laptop:gap-20">
          <div className=" flex flex-col gap-8">
            <h4 className="text-2xl italic font-dream ">
              Join me for a special workshop together with other beautiful
              souls!
            </h4>
            <p className="text-justify">
              Most of my workshops I organize are co-created with other talented
              human beings, sound healers, meditation teachers and coaches to
              bring you unique yoga and wellness experiences. It&lsquo;s all
              about togetherness and sharing knowledge. Each workshop blends
              different styles, expertise, and perspectives, creating a rich and
              transformative space for learning, movement, and connection.
              Whether you&lsquo;re deepening your practice, exploring new
              techniques, or simply looking for inspiration and new connections
              these sessions are designed to support and uplift you.
            </p>
            {isBeforeCutoff && (
              <div className="flex flex-col bg-warm-white p-4 rounded-xl gap-4">
                ...
                <>
                  ...
                  <div className="flex gap-4">
                    ...
                    <a
                      href="mailto:therese@lightbodyyoga.se?subject=Bokning Chitta Vritti Nirodah&body=Hej, jag skulle vilja boka en plats på workshopen Chitta Vritti Nirodah. Namn & telefonnummer: "
                      target="_blank"
                      rel="noopener noreferrer"
          ...
          <img
            src="https://res.cloudinary.com/dknoal1v0/image/upload/t_w-700/v1744214560/dc-therese-lind-bjellder-workshop_lqms06.png"
            className="laptop:w-1/2 aspect-[4/3] rounded-xl object-cover object-left"
          />
        </div>
      </div>
    </section>
