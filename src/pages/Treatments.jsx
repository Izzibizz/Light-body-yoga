        ...
        <div className=" flex flex-col gap-4">
          ...
          <ul>
            <li>
              ...
              relaxation. It’s a grounding, nurturing practice that helps the
              body unwind at its own pace.
            </li>
            <li>
              🌬 Reiki is a quiet, meditative practice where hands are placed
              lightly on or near the body, guiding energy to where it’s needed.
              It can bring a sense of clarity, balance, and emotional release,
              often leaving a feeling of deep calm.
            </li>
            <li>
              💆‍♀️ Healing sessions draw from different techniques, combining
          ...
          <p>
            There’s no right or wrong way to experience these treatments—just an
