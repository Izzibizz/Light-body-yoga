...
<li className="flex gap-4 items-center"> <img src="https://res.cloudinary.com/dknoal1v0/image/upload/v1744216443/circle-bullet_rbd7a8.svg" className="h-[15px]"/>Gentle stretches to release tension from sitting</li>
<li className="flex gap-4 items-center"> <img src="https://res.cloudinary.com/dknoal1v0/image/upload/v1744216443/circle-bullet_rbd7a8.svg" className="h-[15px]"/>Breathing exercises to improve focus and energy</li>
<li className="flex gap-4 items-center"> <img src="https://res.cloudinary.com/dknoal1v0/image/upload/v1744216443/circle-bullet_rbd7a8.svg" className="h-[15px]"/>Positions that support better posture and mobility</li>
<li className="flex gap-4 items-center"> <img src="https://res.cloudinary.com/dknoal1v0/image/upload/v1744216443/circle-bullet_rbd7a8.svg" className="h-[15px]"/>A short relaxation to leave everyone feeling refreshed and focused</li>
<li className="flex gap-4 items-center"> <img src="https://res.cloudinary.com/dknoal1v0/image/upload/v1744216443/circle-bullet_rbd7a8.svg" className="h-[15px]"/>The opportunity to connect with collegue in a fun and genuine way</li>
</ul>
