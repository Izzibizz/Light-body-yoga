             ...
             <img
                ...
                <div className="flex gap-10 laptop:h-full">
                  ...
                  <div className="flex flex-col gap-4 bg-warm-white p-6 laptop:p-8 rounded-xl ">
                    ...
                    <p>
                      ...
                      is by Isadora Duncan, “You were once wild here. Don’t let
              ...
              <div className="flex flex-col gap-4 bg-warm-white p-6 laptop:p-8 rounded-xl laptop:h-full">
                ...
                <p>
                  ...
                  flows into every session, reflecting my dancer’s soul. Beyond
                ...
                <p className="italic">
                  ...
                  lifelong love of movement and the wisdom I’ve gained along the
                  way. Whether in the studio or beyond, I’m here to share the
