      ...
      >
        {testimonials.map((testimonial, index) => (
          <SwiperSlide key={index}>
            <div className="laptop:w-1/2 h-full mx-auto px-15 laptop:px-20 items-center text-justify pt-20 tablet:pt-15 pb-6 bg-warm-white rounded-full rounded-br-none shadow-lg  tablet:text-base cursor-pointer">
